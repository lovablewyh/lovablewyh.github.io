  ...
  $.post(_api, function(rdata) {
    ...
    $(".alarm-view .bt-w-menu p").click( function() {
      ...
      var shtml = '<div class="plugin_user_info c7">\
                            ...
                            <p><button class="btn btn-success btn-sm mt1" onclick="installMsgModuleConfig()">安装模块</button></p>\
                     </div>'
      if (_item['setup']) {
    ...
    if (menu_data) {
      ...
      if(typeof openType != 'undefined' && openType){
        $('.alarm-view .bt-w-menu p:contains('+openType+')').trigger('click')
      }else{
...
function installMsgModuleConfig () {
