    ...
    database_table = bt_tools.table({
      ...
      column:[
        ...
        {fid: 'val',title: '值',type:'text',template:function(row){
            ...
            return '<div class="flex" style="width:350px" title="'+_val.html()+'"><span class="size_ellipsis" style="width: 0; flex: 1;">'+_val.html()+'</span><span class="ico-copy cursor btcopy ml5" title="复制密码"></span></div>'
